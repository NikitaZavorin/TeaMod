...
package net.mcreator.taskthree.world.inventory;
...
import net.mcreator.taskthree.init.TaskthreeModMenus;

import java.util.function.Supplier;
import java.util.Map;
import java.util.HashMap;

public class TeaBagGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TeaBagGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TaskthreeModMenus.TEA_BAG_GUI.get(), id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 115, 62) {
		}));
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 97, 8) {
		}));
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 151, 62) {
		}));
